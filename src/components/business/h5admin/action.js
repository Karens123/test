...
//1. 模糊查询静态数据列表
export const QRY_H5_BY_FORM = 'QRY_H5_BY_FORM';
...
//2. 精确查询某个静态数据对象
export const QRY_H5_BY_ID = 'QRY_H5_BY_ID';
...
//4.批量删除静态数据
export const DELETE_H5 = 'DELETE_H5';
...
export const INIT_A_H5_FOR_ADD = 'INIT_A_H5_FOR_ADD';
export function initAStaticDataForAdd () {
	return {
		type: INIT_A_H5_FOR_ADD,
		payload: {},
	};
}
