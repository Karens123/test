...
export const PrayerActivitySearchFormCacheKey = 'PrayerActivitySearchForm';
const Option = Select.Option;
class PrayerActivitySearchForm extends React.Component {
	...
	render () {
		...
		const query = () => {
			...
			localStorage.setItem(PrayerActivitySearchFormCacheKey,
...
export default Form.create()(PrayerActivitySearchForm);
