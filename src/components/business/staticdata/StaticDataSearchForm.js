...
export const StaticDataSearchFormCacheKey = 'StaticDataSearchForm';

class StaticDataSearchForm extends React.Component {
	static propTypes = {
	...
	render () {
		...
		const query = () => {
			...
			localStorage.setItem(StaticDataSearchFormCacheKey,
...
export default Form.create()(StaticDataSearchForm);
